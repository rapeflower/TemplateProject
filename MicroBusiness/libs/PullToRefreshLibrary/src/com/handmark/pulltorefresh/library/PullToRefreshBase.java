...
import com.handmark.pulltorefresh.library.internal.J1FooterLoadingLayout;
import com.handmark.pulltorefresh.library.internal.J1HeaderLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, final Mode mode, Orientation scrollDirection, TypedArray attrs) {

            //不需要匹配之前的两种动画方式 刘文静 2016/04/22 case ROTATE:case FLIP:
            if (mode == Mode.PULL_FROM_START) {
                return new J1HeaderLoadingLayout(context, mode, scrollDirection, attrs);
            } else if (mode == Mode.PULL_FROM_END) {
                return new J1FooterLoadingLayout(context, mode, scrollDirection, attrs);
            }
