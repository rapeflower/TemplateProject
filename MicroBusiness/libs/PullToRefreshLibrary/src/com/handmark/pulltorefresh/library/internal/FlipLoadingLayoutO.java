...
public class FlipLoadingLayoutO extends LoadingLayout {

	static final int FLIP_ANIMATION_DURATION = 150;

	private final Animation mRotateAnimation, mResetRotateAnimation;

	public FlipLoadingLayoutO(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
	...
	protected void pullToRefreshImpl() {
		...
		if (mRotateAnimation == mFooterImage.getAnimation()) {
			mFooterImage.startAnimation(mResetRotateAnimation);
		}
	}
...
//TODO		mHeaderProgress.setVisibility(View.VISIBLE);
	}
	...
	protected void resetImpl() {
		mFooterImage.clearAnimation();
//TODO		mHeaderProgress.setVisibility(View.GONE);
